...
Allow browser to use a camera, select from menu face, hands or filtering effects, play with settings to adjust them. Use full screen mode (F11) for better experience.
